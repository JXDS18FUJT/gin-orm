...
func BaiduWebimage(c *gin.Context) {
	...
	//把post表单发送给目标服务器
	resp, err := http.PostForm("https://aip.baidubce.com/rest/2.0/ocr/v1/webimage?access_token=24.2f5612a038f5c41bf4b370fceca502fc.2592000.1618729517.282335-23829922", data)
	if err != nil {
	...
	c.JSON(http.StatusOK, gin.H{
		"message": webimageResult.Words_result,
	})
